...
import AddPersonalLogisticsDialog from "./AddPersonalLogisticsDialog";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
interface PersonalLogisticsTabProps {
  eventId: string;
}

const PersonalLogisticsTab = ({ eventId }: PersonalLogisticsTabProps) => {
  ...
  const groupedByCategory = personalLogisticsCategories.map(cat => ({
    ...cat,
...
export default PersonalLogisticsTab;
