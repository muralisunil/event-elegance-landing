...
interface ManagePersonalEventTypesDialogProps {
  open: boolean;
...
export const ManagePersonalEventTypesDialog = ({ open, onOpenChange, event, onSuccess }: ManagePersonalEventTypesDialogProps) => {
