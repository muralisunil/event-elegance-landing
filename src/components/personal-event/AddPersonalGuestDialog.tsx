...
interface AddPersonalGuestDialogProps {
  open: boolean;
...
const AddPersonalGuestDialog = ({ open, onOpenChange, eventId, guest, onSuccess }: AddPersonalGuestDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = guest
      ? await supabase.from('personal_event_guests').update(payload).eq('id', guest.id)
      : await supabase.from('personal_event_guests').insert([payload]);
...
export default AddPersonalGuestDialog;
